...
ActiveRecord::Schema.define(version: 20150328071342) do
  ...
  create_table "blog_post_items", force: true do |t|
  ...
  create_table "spree_addresses", force: true do |t|
    ...
    t.string   "alternative_phone", limit: nil
  ...
  create_table "spree_adjustments", force: true do |t|
    ...
    t.string   "adjustable_type", limit: nil
  ...
  create_table "spree_assets", force: true do |t|
    ...
    t.integer  "position"
    t.string   "attachment_content_type", limit: nil
    t.string   "attachment_file_name",    limit: nil
  ...
  create_table "spree_calculators", force: true do |t|
    ...
    t.string   "calculable_type", limit: nil
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.text     "preferences"
  end
  ...
  create_table "spree_countries", force: true do |t|
    t.string   "iso_name",        limit: nil
    t.string   "iso",             limit: nil
  ...
  create_table "spree_credit_cards", force: true do |t|
    t.string   "month",                       limit: nil
    t.string   "year",                        limit: nil
    t.string   "cc_type",                     limit: nil
    t.string   "last_digits",                 limit: nil
    t.integer  "address_id"
    t.string   "gateway_customer_profile_id", limit: nil
    t.string   "gateway_payment_profile_id",  limit: nil
    t.datetime "created_at",                                              null: false
    t.datetime "updated_at",                                              null: false
    t.string   "name",                        limit: nil
    t.integer  "user_id"
  ...
  create_table "spree_gateways", force: true do |t|
    ...
    t.string   "environment", limit: nil, default: "development"
    t.string   "server",      limit: nil, default: "test"
  ...
  create_table "spree_option_values", force: true do |t|
    t.integer  "position"
    t.string   "name",           limit: nil
    t.string   "presentation",   limit: nil
    t.integer  "option_type_id"
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
  ...
  create_table "spree_orders", force: true do |t|
    ...
    t.string   "shipment_state",         limit: nil
    t.string   "payment_state",          limit: nil
    t.string   "email",                  limit: nil
    t.text     "special_instructions"
    t.datetime "created_at",                                                                    null: false
    t.datetime "updated_at",                                                                    null: false
    t.string   "currency",               limit: nil
    t.string   "last_ip_address",        limit: nil
    t.integer  "created_by_id"
    t.decimal  "shipment_total",                     precision: 10, scale: 2, default: 0.0,     null: false
    t.decimal  "additional_tax_total",               precision: 10, scale: 2, default: 0.0
    t.decimal  "promo_total",                        precision: 10, scale: 2, default: 0.0
    t.string   "channel",                limit: nil,                          default: "spree"
    t.decimal  "included_tax_total",                 precision: 10, scale: 2, default: 0.0,     null: false
    ...
    t.string   "guest_token",            limit: nil
  ...
  create_table "spree_payments", force: true do |t|
    ...
    t.integer  "payment_method_id"
    t.string   "state",                limit: nil
    t.string   "response_code",        limit: nil
    t.string   "avs_response",         limit: nil
    t.datetime "created_at",                                                              null: false
    t.datetime "updated_at",                                                              null: false
    t.string   "number",               limit: nil
    t.string   "cvv_response_code",    limit: nil
    t.string   "cvv_response_message", limit: nil
  end
  ...
  create_table "spree_products", force: true do |t|
    ...
    t.string   "meta_keywords",        limit: nil
    t.integer  "tax_category_id"
    t.integer  "shipping_category_id"
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.boolean  "promotionable",                    default: true
    t.string   "meta_title",           limit: nil
  end
  ...
  create_table "spree_promotions", force: true do |t|
    ...
    t.string   "match_policy",          limit: nil, default: "all"
    t.string   "code",                  limit: nil
  ...
  create_table "spree_properties", force: true do |t|
    t.string   "name",         limit: nil
    t.string   "presentation", limit: nil, null: false
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end
  ...
  create_table "spree_refunds", force: true do |t|
    t.integer  "payment_id"
    t.decimal  "amount",                       precision: 10, scale: 2, default: 0.0, null: false
    t.string   "transaction_id",   limit: nil
    t.datetime "created_at",                                                          null: false
    t.datetime "updated_at",                                                          null: false
  ...
  create_table "spree_reimbursement_credits", force: true do |t|
    ...
    t.string  "creditable_type",  limit: nil
  end
  ...
  create_table "spree_reimbursements", force: true do |t|
    t.string   "number",               limit: nil
    t.string   "reimbursement_status", limit: nil
  ...
  create_table "spree_return_items", force: true do |t|
    ...
    t.string   "reception_status",                limit: nil
    t.string   "acceptance_status",               limit: nil
    t.integer  "customer_return_id"
    t.integer  "reimbursement_id"
  ...
  create_table "spree_shipping_methods", force: true do |t|
    ...
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.string   "tracking_url",    limit: nil
    t.string   "admin_name",      limit: nil
    t.integer  "tax_category_id"
    t.string   "code",            limit: nil
  end
  ...
  create_table "spree_skrill_transactions", force: true do |t|
    ...
    t.string   "payment_type",   limit: nil
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_state_changes", force: true do |t|
    t.string   "name",           limit: nil
    t.string   "previous_state", limit: nil
    t.integer  "stateful_id"
    t.integer  "user_id"
    t.string   "stateful_type",  limit: nil
    t.string   "next_state",     limit: nil
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
  ...
  create_table "spree_stores", force: true do |t|
    ...
    t.string   "seo_title",         limit: nil
    t.string   "mail_from_address", limit: nil
    t.string   "default_currency",  limit: nil
    t.string   "code",              limit: nil
    t.boolean  "default",                       default: false, null: false
    t.datetime "created_at",                                    null: false
    t.datetime "updated_at",                                    null: false
  ...
  create_table "spree_taxons", force: true do |t|
    ...
    t.integer  "position",                      default: 0
    t.string   "name",              limit: nil,             null: false
    t.string   "permalink",         limit: nil
    t.integer  "taxonomy_id"
    t.integer  "lft"
    t.integer  "rgt"
    t.string   "icon_file_name",    limit: nil
    t.string   "icon_content_type", limit: nil
    ...
    t.datetime "updated_at",                                null: false
    t.string   "meta_title",        limit: nil
    t.string   "meta_description",  limit: nil
    t.string   "meta_keywords",     limit: nil
    t.integer  "depth"
  end
  ...
  create_table "spree_trackers", force: true do |t|
    t.string   "analytics_id", limit: nil
    t.boolean  "active",                   default: true
    t.datetime "created_at",                              null: false
    t.datetime "updated_at",                              null: false
  end
  ...
  create_table "spree_variants", force: true do |t|
    t.string   "sku",               limit: nil,                          default: "",    null: false
    ...
    t.decimal  "cost_price",                    precision: 10, scale: 2
    t.integer  "position"
    t.string   "cost_currency",     limit: nil
  ...
  create_table "spree_zone_members", force: true do |t|
    ...
    t.string   "zoneable_type", limit: nil
    t.integer  "zone_id"
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
  end
